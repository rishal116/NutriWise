...
update(id: string, data: Partial<ITaskLog>): Promise<void>;
    ...
    findByDate(userId: Types.ObjectId,userProgramId: Types.ObjectId,date: Date): Promise<ITaskLog | null>;
    getLogsByProgram(userProgramId: Types.ObjectId): Promise<ITaskLog[]>;
    getRecentLogs(userProgramId: Types.ObjectId,limit: number): Promise<ITaskLog[]>;
}