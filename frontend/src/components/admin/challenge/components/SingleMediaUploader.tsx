    ...
    <div>
      ...
      {value ? (
        ...
        <div
          ...
          className={`flex flex-col items-center justify-center gap-3 py-10 rounded-2xl border-2 border-dashed cursor-pointer transition-all duration-200 ${uploading
        ...
        >
          {uploading ? (
            ...
            <>
              <div
                className={`w-12 h-12 rounded-2xl flex items-center justify-center ${isImage
